...
public class Dinglemouse {
    ...
    public static long[] clonewars(int kataPerDay) {
        ...
        long clones = 1;
        long totalKataSolved = 0;
        int k = kataPerDay;
        while (k > 0) {
            totalKataSolved += clones * k;
            clones *= 2;
            k--;
        }
        return new long[] { clones / 2, totalKataSolved };
    }

    public static void main(String[] args) {
        System.out.println(Arrays.toString(clonewars(0)));
        System.out.println(Arrays.toString(clonewars(1)));
        System.out.println(Arrays.toString(clonewars(5)));
        System.out.println(Arrays.toString(clonewars(10)));
    }
}